...
#  Приветитвие игроков.
print('>' * 5, 'Добро пожаловать в игру!!!', '<' * 5)
print('>' * 9, name_game, '<' * 10)
...
print(
    'Победа за тем игроком, кто первым соберет линию своих знаков по горизонтали, или по вертикали, или по одной из диогоналей.')
print("Начнём!")
